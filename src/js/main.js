...
function saveBudget() {
    ...
    const modal = bootstrap.Modal.getInstance(document.getElementById('saveBudget'))
    modal.hide()
}
...
function saveTeam() {
    ...
    const modal = bootstrap.Modal.getInstance(document.getElementById('savePlatform'))
    modal.hide()
}
